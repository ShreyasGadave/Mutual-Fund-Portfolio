...
const MovingBar = () => {
  ...
  return (
<div className="border mt-10 border-gray-500 bg-gradient-to-r from-red-300 to-blue-300 py-2 overflow-hidden whitespace-nowrap relative -rotate-1 cursor-wait">
    {/* Left blur effect */}
    <div
    ...
    <motion.div
      ...
      transition={{ repeat: Infinity, duration: 180, ease: "linear" }} // Adjust duration for speed
